...
Seeeduino XIAO ESP32S3|∼$10	|Microcontroller with Bluetooth HID and high performance for driving the screen. (Simplified: Using the module to avoid complex chip soldering).
1.28" Round LCD (GC9A01)|∼$15|Display for real-time visual feedback (volume, track status).
